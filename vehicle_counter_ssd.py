...
# input video
source_video = r'C:\Users\Chocky Naresh\Desktop\Computer Vision\Vehicle_counter\Cars Moving On Road Stock Footage - Free Download.mp4'
...
# I use an "SSD with Mobilenet" model here. See the detection model zoo (https://github.com/tensorflow/models/blob/master/research/object_detection/g3doc/detection_model_zoo.md) 
    ...
    with detection_graph.as_default():
        with tf.compat.v1.Session(graph=detection_graph) as sess:
            ...
            while cap.isOpened():
                ...
                if counter == 1:
                    cv2.line(input_frame, (0, 200), (1200, 200), (0, 0xFF, 0), 5)
                else:
                    cv2.line(input_frame, (0, 200), (1200, 200), (0, 0, 0xFF), 5)
